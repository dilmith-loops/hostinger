            ...
            <table align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;border-collapse:collapse;">
              <tr>
                <td style="vertical-align:middle;padding-right:16px;">
                  <img src="{{ $message->embed(public_path('logo-icon.png')) }}" alt="Logo" width="28" height="62" style="display:block;border:0;width:28px;height:62px;" />
                </td>
                <td style="vertical-align:middle;text-align:left;line-height:1.1;">
                  <span style="font-family:'Inter',Arial,sans-serif;font-size:13px;color:#ffffff;font-weight:400;letter-spacing:0.08em;display:block;text-transform:uppercase;opacity:0.85;">Ceylon</span>
                  <span style="font-family:'Inter',Arial,sans-serif;font-size:24px;color:#ffffff;font-weight:800;letter-spacing:0.02em;display:block;margin-top:1px;">Talent</span>
                  <span style="font-family:'Inter',Arial,sans-serif;font-size:24px;color:#ffffff;font-weight:800;letter-spacing:0.02em;display:block;margin-top:1px;">Connect</span>
                </td>
              </tr>
            </table>
          </td>
