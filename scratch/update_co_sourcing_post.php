...
$postsContent = App\Models\PageContent::where('page', 'blog')->where('key', 'posts')->first();
$posts = $postsContent->value;
...
if ($updated) {
    $postsContent->value = $posts;
    $postsContent->save();
    echo "Successfully updated 'Advantages of Co-Sourcing' HTML structure in the database!\n";
} else {
    echo "Post not found.\n";
}
